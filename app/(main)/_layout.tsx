...
export default function MainLayout() {
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="profile/likedItems" options={{ href: null }} />
      <Tabs.Screen name="profile/savedItems" options={{ href: null }} />
      <Tabs.Screen name="profile/myClubs" options={{ href: null }} />
